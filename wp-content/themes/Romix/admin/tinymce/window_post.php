		...
		<table border="0" cellpadding="4" cellspacing="0">
         <tr>
            ...
            <select id="style_shortcode" name="style_shortcode" style="width: 200px">
                ...
                <option value="cta"><?php _e('Call To Action Box','highthemes'); ?></option>
                ...
                <optgroup label="<?php _e('Image Frames','highthemes'); ?>">
                 <option value="lightbox_image"><?php _e('Image With Lightbox Effect','highthemes'); ?></option>
                <option value="frame_left"><?php _e('Left Aligned','highthemes'); ?></option>
                <option value="frame_right"><?php _e('Right Aligned','highthemes'); ?></option>
                <option value="frame_center"><?php _e('Centered','highthemes'); ?></option>
                <option value="frame"><?php _e('Not Aligned','highthemes'); ?></option>
                
                </optgroup>
                
                <optgroup label="<?php _e('Tabs, Accordings, Toggles','highthemes'); ?>">
                 <option value="tabs"><?php _e('Tabs','highthemes'); ?></option>
                 <option value="accordions"><?php _e('Accordiona','highthemes'); ?></option>
                 
               	 <option value="simple_toggle"><?php _e('Simple Toggle','highthemes'); ?></option>
               	 <option value="framed_toggle"><?php _e('Framed Toggle','highthemes'); ?></option>                
                </optgroup>                
              </select>
            </td>
          </tr>
		...
		<table border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            ...
            <td><select id="button_color" name="button_color" style="width: 100px">
            	...
            	<option value="rosy"><?php _e('Rosy','highthemes'); ?></option>
            	...
            	<option value="white"><?php _e('White','highthemes'); ?></option>
            	...
            	<option value="teal"><?php _e('Teal','highthemes'); ?></option>
            	<option value="yellow"><?php _e('Yellow','highthemes'); ?></option>
              </select><br /></td>
          </tr>
		...
		<table border="0" cellpadding="4" cellspacing="0">         
          ...
          <tr>
            ...
            <td><select id="list_type" name="list_type" style="width: 100px">
            	...
            	<option value="rec-bulletlist"><?php _e('Rectangle Bullets','highthemes'); ?></option>
            	<option value="arrowlist"><?php _e('Arrow','highthemes'); ?></option>
            	<option value="bulletlist"><?php _e('Circle Bullet','highthemes'); ?></option>
            	<option value="starlist"><?php _e('Star','highthemes'); ?></option>
            	<option value="arrow1list"><?php _e('Arrow 1','highthemes'); ?></option>
            	<option value="arrow2list"><?php _e('Arrow 2','highthemes'); ?></option>
            	<option value="heartlist"><?php _e('Heart','highthemes'); ?></option>
            	<option value="downloadlist"><?php _e('Download','highthemes'); ?></option>
            	<option value="questionlist"><?php _e('Question','highthemes'); ?></option>
            	<option value="flaglist"><?php _e('Flag','highthemes'); ?></option>
            	<option value="helplist"><?php _e('Help','highthemes'); ?></option>
            	<option value="commentlist"><?php _e('Comment','highthemes'); ?></option>
            	<option value="voicelist"><?php _e('Voice','highthemes'); ?></option>
...
<br />
		...
		<table border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            <td nowrap="nowrap"><label for="sbox_gradient"><?php _e('Gradient? ','highthemes'); ?></label></td>
            <td><select id="sbox_gradient" name="sbox_gradient" style="width: 100px">
            	<option value="true"><?php _e('Yes','highthemes'); ?></option>
                <option value="false"><?php _e('No','highthemes'); ?></option>
              </select><br /></td>
          </tr>        
          ...
          <tr>
            ...
            <td><select id="sbox_border_color" name="sbox_border_color" style="width: 100px">
            	...
            	<option value="#d8616f"><?php _e('Rosy','highthemes'); ?></option>
            	...
            	<option value="#479ea3"><?php _e('Teal','highthemes'); ?></option>
            	<option value="#f1af1f"><?php _e('Yellow','highthemes'); ?></option>
              </select><br /></td>
          </tr>
...
<br />
		...
		<table border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            <td nowrap="nowrap"><label for="tbox_gradient"><?php _e('Gradient? ','highthemes'); ?></label></td>
            <td><select id="tbox_gradient" name="tbox_gradient" style="width: 100px">
            	<option value="true"><?php _e('Yes','highthemes'); ?></option>
                <option value="false"><?php _e('No','highthemes'); ?></option>
              </select><br /></td>
          </tr>        
		...
		<table border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            ...
            <td><select id="link_icon" name="link_icon" style="width: 100px">
            	<option value="rss-icon"><?php _e('RSS','highthemes'); ?></option>
            	<option value="search-icon"><?php _e('Search','highthemes'); ?></option>
            	<option value="arrow1-icon"><?php _e('Arrow 1','highthemes'); ?></option>                
            	<option value="arrow2-icon"><?php _e('Arrow 2','highthemes'); ?></option>
            	<option value="email-icon"><?php _e('Email','highthemes'); ?></option>
            	<option value="print-icon"><?php _e('Print','highthemes'); ?></option>
            	<option value="home-icon"><?php _e('Home','highthemes'); ?></option>
            	<option value="delete-icon"><?php _e('Delete','highthemes'); ?></option>
            	...
            	<option value="clip-icon"><?php _e('Clip','highthemes'); ?></option>
            	<option value="twitter-icon"><?php _e('Twitter','highthemes'); ?></option>
            	<option value="user-icon"><?php _e('User','highthemes'); ?></option>
            	<option value="calendar-icon"><?php _e('Calendar','highthemes'); ?></option>
            	<option value="download-icon"><?php _e('Download','highthemes'); ?></option>
            	<option value="tag-icon"><?php _e('Tag','highthemes'); ?></option>
